    ...
    return (
        ...
        >
            <div className="flex flex-col space-y-1">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><IdCard className="text-sm" size={25} /><p>ID</p></h1>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><BadgeDollarSign className="text-sm" size={25} /><p>Price</p></h1>
                <p>Svcs:$180</p>
                <p>Est Tip: $30</p>
                <p>Est PF: $24</p>
                <p>Act Tip: $0</p>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><FileUser className="text-sm" size={25} /><p>Client</p></h1>
                <p>Ava DeSena</p>
                <p>643 345 4456</p>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><ContactRound className="text-sm" size={25} /><p>Agent</p></h1>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><Clock className="text-sm" size={25} /><p>Job Time</p></h1>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><Fan className="text-sm" size={25} /><p>Services</p></h1>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><MapPin className="text-sm" size={25} /><p>Address</p></h1>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><BadgeDollarSign className="text-sm" size={25} /><p>Fees</p></h1>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><TimerReset className="text-sm" size={25} /><p>Last Event</p></h1>
            ...
            <div className="flex flex-col space-y-1 items-center">
                <h1 className="flex justify-center space-x-1 shadow mb-2 font-bold text-center w-full"><Building2 className="text-sm" size={25} /><p>City</p></h1>
                <p>Washington</p>
                <p>DC</p>
            </div>
